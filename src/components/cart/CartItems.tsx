    ...
    return (
        <div className="w-100">
            {cartProducts.length !== 0 ? (
                    ...
                    <div key={p.id} className="row col-12 g-0 justify-content-around border-bottom pb-4 mb-4">
                        ...
                        <div className="col-5">
                            <div className="card-body">
                                <Link href={"/products/" + p.id} className="card-title fs-4 mb-3 text-primary fw-bold text-decoration-none">{p.name}</Link>
                            ...
                            <div className="row">
                                <label className="me-2 fw-medium col-12 ms-0">Quantity : {p.quantity}</label>
                ...
                <p className="text-center fs-4 fw-medium" style={{marginTop: "200px"}}>No items in the cart.</p>
            )}
        </div>
    );
