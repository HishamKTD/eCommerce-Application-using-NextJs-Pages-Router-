...
function Footer() {
  ...
  return (
    <footer className={"footer"}>
        <div className={"footrContactSection"}>
          <div className={"footerLinkSection"}>
            <div className={"footerLinkBox"}>
              <div className={"footerLinkHead"}>ABOUT</div>
            ...
            <div className={"footerLinkBox"}>
              <div className={"footerLinkHead"}>HELP</div>
            ...
            <div className={"footerLinkBox"}>
              <div className={"footerLinkHead"}>CONSUMER POLICY</div>
            ...
            <div className={"footerLinkBox"}>
              <div className={"footerLinkHead"}>SOCIAL MEDIA</div>
          ...
          <div className={"footerAddressSection"}>
            <div className={"footerAddressContainer"}>
              <div className={"addressHead"}>Mail Us:</div>
