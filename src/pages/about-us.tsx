...
import AboutImg01 from "../asset/about-us-img-01.png";
import AboutImg02 from "../asset/about-us-img-02.png";
      ...
      <div className="m-auto" style={{ width: "90%" }}>
        ...
        >
          <div className="col-5 ps-5">
            ...
            <h5 className="fw-normal">
              ...
              hats, sunglasses, and jewelry, they have it all. UrbanCartel is
              the all-in-one commerce platform to start, run, and grow a
              business. Check them out now!
            </h5>
        ...
        <div className="row justify-content-around mt-5 mb-5">
          ...
          <div className="col-6">
            ...
            <p className="text-wrap fs-5 opacity-75">
              ...
              individuality, a showcase of curated craftsmanship, and a
              community where style knows no bounds. From late-night
              brainstorming sessions to navigating the ever-evolving digital
              landscape, we've grown from a small team with big dreams to a
              dynamic marketplace. Our handpicked collections feature products
              from artisans, independent designers, and renowned brands. At
              UrbanCartel, each click is an invitation to explore a world of
              style, sophistication, and seamless shopping. Join us on this
              incredible journey, where we continue to shape the future of
              online retail. Thank you for being a part of UrbanCartel - where
              style meets convenience. Welcome to UrbanCartel, your destination
              for curated fashion and a seamless shopping experience.
            </p>
          </div>
        </div>
        <div className="text-center p-5">
          ...
          <p className="fs-5 opacity-75 mt-2">
            ...
            those who seek curated fashion and a shopping journey that goes
            beyond mere transactions.
          </p>
        </div>
        <div className="text-center p-5 m-5">
          <h4>
            Unlock your business potential with UrbanCartel. Try UrbanCartel the
            perfect platform to start, run, and grow your online venture with
