...
import GoToBack from "../../components/buttons/GoToBack";
import ProductRating from "../../components/product-rating/ProductRating";
import DownArrow from "../../asset/chevron-down.svg";
import OnAddToCart from "../../components/add-to-cart/OnAddToCart";
...
export default  function ProductDetail() {
  ...
  var productId: any = router.query.productId;
